! function() {
    ...
    function e() {
        var e = $('<li class="menu__item selector" data-action="hd"><div class="menu__ico">' + _ + '</div><div class="menu__text">HULU</div></li>');
    ...
    function l() {
        var e = $('<li class="menu__item selector" data-action="kp"><div class="menu__ico">' + _ + '</div><div class="menu__text">CW</div></li>');
        e.on("hover:enter", function() {
            Lampa.Activity.push({
                url: "discover/tv?language=ru&with_networks=71",
                title: "CW",
                component: "category_full",
                source: "tmdb",
                sort: "now",
