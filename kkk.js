! function() {
    ...
    function e() {
        var _ = $('<li class="menu__item selector" data-action="hbo"><div class="menu__ico">' + _ + '</div><div class="menu__text">hbo</div></li>');
    ...
    window.plugin_podbor_ready || function _() {
        function v() {
            window.plugin_podbor_ready || ("1" == Lampa.Storage.get("porborki_kach") && e(), "1" == Lampa.Storage.get("porborki_rus") && r(), "1" == Lampa.Storage.get("porborki_okko") && t(), "1" == Lampa.Storage.get("porborki_ivi") && n(), "1" == Lampa.Storage.get("porborki_wink") && o(), "1" == Lampa.Storage.get("porborki_kion") && i(), "1" == Lampa.Storage.get("porborki_netflix") && a(), "1" == Lampa.Storage.get("porborki_kr") && c(), "1" == Lampa.Storage.get("porborki_kp") && l(), "1" == Lampa.Storage.get("porborki_mult12") && u(), "1" == Lampa.Storage.get("porborki_mult13") && s(), "1" == Lampa.Storage.get("porborki_mult14") && m(), "1" == Lampa.Storage.get("porborki_mult15") && p(), "1" == Lampa.Storage.get("porborki_start") && d()), window.plugin_podbor_ready = !0, Lampa.SettingsApi.addComponent({
                ...
                onChange: function(_) {
                    1 == _ && 0 == $('[data-action="hbo"]').length ? e() : Lampa.Helper.show("Необходимо переоткрыть Lampa")
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
